export const ROLES = [
  ...
  },
  {
    ...
    icon: '👥',
    tier: 'Project',
    desc: 'Core features only — no UI Scanner, Healing, TC Library import, or test case delete.',
  },
  {
    key: 'TEST_USER',
    label: 'Test User',
    ...
    icon: '🧪',
    tier: 'Project',
    desc: 'Test Management only (TC Library, Test Cycles, Test Dashboard, My Assignments) — no Automation features.',
  },
] as const;
